<template>
  <div>
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Annuaire des membres</h1>

    <div class="mb-4">
      <input v-model="search" placeholder="Rechercher par nom..."
    ...
    <div v-else-if="members.length === 0" class="text-center py-12 text-gray-400">Aucun membre trouvé.</div>
    ...
    <p v-if="members.length > 0" class="text-center text-sm text-gray-400 mt-4">{{ members.length }} membres</p>
  </div>
</template>
