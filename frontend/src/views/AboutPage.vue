<template>
  <div class="max-w-4xl mx-auto dark:text-gray-100">
    <div class="mb-6">
      <router-link to="/" class="text-blue-600 hover:underline text-sm">{{$t('about.back')}}</router-link>
    </div>

    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <router-link to="/compare"
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-300 mt-1">Tableau Planning Center vs Église App + vision "modules standalone".</p>
          </div>
        </router-link>
        <router-link to="/plans"
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-300 mt-1">{{ $t('about.module_services_desc') }}</p>
          </div>
        </router-link>
        ...
        <router-link to="/members"
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-300 mt-1">{{ $t('about.module_members_desc') }}</p>
          </div>
        </router-link>
        ...
        <router-link to="/songs"
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-300 mt-1">{{ $t('about.module_music_desc') }}</p>
          </div>
        </router-link>
        ...
        <router-link to="/email"
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-300 mt-1">{{ $t('about.module_communication_desc') }}</p>
          </div>
        </router-link>
        ...
        <router-link to="/admin"
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-300 mt-1">{{ $t('about.module_admin_desc') }}</p>
          </div>
        </router-link>
      </div>
    </div>

    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 text-center text-sm text-gray-400 dark:text-gray-500">
