<template>
  <div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <router-link to="/compare"
          class="flex items-start gap-4 p-4 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors md:col-span-2">
        ...
        <router-link to="/plans"
          class="flex items-start gap-4 p-4 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
          <span class="text-3xl mt-1">📋</span>
          <div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 p-6 text-center text-sm text-gray-400 dark:text-gray-500">
