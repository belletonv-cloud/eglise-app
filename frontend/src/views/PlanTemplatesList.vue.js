...
const form = ref({ name: '', description: '', service_type_id: null });
async function load() {
    try {
...
(__VLS_ctx.$t('planTemplates.title'));
...
if (__VLS_ctx.loading) {
    ...
    (__VLS_ctx.$t('planTemplates.loading'));
}
    ...
    for (const [tpl] of __VLS_vFor((__VLS_ctx.templates))) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ onClick: (...[$event]) => {
                    ...
                    if (!!(__VLS_ctx.error))
                        return;
                    __VLS_ctx.$router.push(`/plan-templates/${tpl.id}`);
                    // @ts-ignore
                    [$t, $t, loading, error, error, templates, $router,];
                } },
            key: (tpl.id),
        ...
        /** @type {__VLS_StyleScopedClasses['text-gray-500']} */ ;
        (tpl.item_count || 0);
        (__VLS_ctx.$t('planTemplates.items'));
        // @ts-ignore
        [$t,];
    }
    if (__VLS_ctx.templates.length === 0) {
        ...
        (__VLS_ctx.$t('planTemplates.not_found'));
    }
}
if (__VLS_ctx.showForm) {
    ...
    (__VLS_ctx.$t('planTemplates.create_title'));
    ...
    (__VLS_ctx.$t('planTemplates.name'));
    ...
    /** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
    /** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
    (__VLS_ctx.$t('planTemplates.description'));
    ...
    for (const [st] of __VLS_vFor((__VLS_ctx.serviceTypes))) {
        ...
        (st.name);
        // @ts-ignore
        [$t, $t, $t, $t, $t, createTemplate, form, form, form, serviceTypes,];
    }
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    /** @type {__VLS_StyleScopedClasses['rounded-lg']} */ ;
    /** @type {__VLS_StyleScopedClasses['cursor-pointer']} */ ;
    (__VLS_ctx.$t('planTemplates.cancel'));
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        type: "submit",
        ...{ class: "px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 cursor-pointer" },
    });
    ...
    /** @type {__VLS_StyleScopedClasses['hover:bg-blue-700']} */ ;
    /** @type {__VLS_StyleScopedClasses['cursor-pointer']} */ ;
    (__VLS_ctx.$t('planTemplates.create'));
}
// @ts-ignore
[$t, $t,];
