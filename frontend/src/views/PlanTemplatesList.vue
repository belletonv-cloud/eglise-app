            ...
            >
                ...
                <form @submit.prevent="createTemplate" class="space-y-4">
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
                            >{{ $t("planTemplates.description") }}</label
                        >
                        <textarea
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
                            >{{ $t("planTemplates.service_type") }}</label
                        >
                        <select
                    ...
                    <div class="flex gap-3 justify-end">
                        <button
                            ...
                            class="px-4 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg cursor-pointer"
                        >
                            {{ $t("planTemplates.cancel") }}
                        </button>
                        <button
                            type="submit"
