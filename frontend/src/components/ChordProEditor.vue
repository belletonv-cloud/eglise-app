...
[C]Paroles avec [G]accords"
                ...
                <div class="help-text">
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        <strong>Syntaxe ChordPro :</strong> [C] = Do, [G] = Sol,
                        [Am] = La mineur
                    </p>
                </div>
            </div>
            ...
            <div class="preview-section">
                ...
                <div
                    v-else
                    class="preview-empty text-gray-400 dark:text-gray-500 text-center py-8"
                >
...
async function save() {
    ...
    message.value = null;
    try {
        await api.updateArrangement(props.arrangementId, {
            chord_chart: localChart.value,
        });
        ...
        message.value = {
            type: "error",
            text: e.message || "Erreur lors de la sauvegarde",
        };
    } finally {
        saving.value = false;
    }
