<template>
  <div class="px-4 pt-5 pb-3">
    ...
    <div class="mt-2">
      <div class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100">
        {{ personName }}
      </div>
    </div>
    ...
    <div class="mt-3 grid grid-cols-2 gap-2">
      <button
        @click="addBlockout"
        class="rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-800 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200"
      >
        Add Blockout
      </button>
      <button
    ...
    <div v-else>
      <div class="mt-5">
        ...
        <div
          ...
          :key="idx"
          class="mt-2 rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900"
        >
          ...
          <div class="mt-3 grid grid-cols-2 gap-2">
            <button
              @click="decline(idx)"
              class="rounded-lg border border-red-400 bg-white px-3 py-2 text-sm font-semibold text-red-600 dark:border-red-600 dark:bg-gray-900 dark:text-red-400"
            >
              Decline
            </button>
            <button
              @click="accept(idx)"
              class="rounded-lg border border-[#2ECC71] bg-white px-3 py-2 text-sm font-semibold text-[#2ECC71] dark:bg-gray-900"
            >
              Accept
            </button>
          </div>
